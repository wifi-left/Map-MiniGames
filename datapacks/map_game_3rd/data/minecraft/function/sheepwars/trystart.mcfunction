...
execute as @a[team=wait.sheepwars,gamemode=adventure] run scoreboard players add wait.player tick 1


execute if score sheepwars.state state matches 1.. run return run function minecraft:sheepwars/spec
...
execute if score wait.player tick matches 2.. in airworld run function minecraft:sheepwars/start