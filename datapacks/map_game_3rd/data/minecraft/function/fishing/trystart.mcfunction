...
execute as @a[team=fishing,gamemode=adventure] run scoreboard players add wait.player tick 1


execute if score fishing.state state matches 1.. run return run function minecraft:fishing/spec
...
execute if score wait.player tick matches 2.. run function minecraft:fishing/start
