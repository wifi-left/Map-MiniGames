...
execute as @a[tag=fishing.win] run tellraw @s ["\u00a7a第一名（你）：",{selector:"@a[tag=fishing.win]",color:aqua},{text:" (",color:green,extra:["",{score:{name:"fishing.max",objective:board},color:"light_purple"},"分)"]}]
...
tag @a[tag=fishing.win] remove fishing.tobecalc
execute as @a[tag=fishing.win] run team leave @s
execute as @a[tag=fishing.win] run tellraw @s ["\u00a7e第二名（你）：",{selector:"@a[tag=fishing.win]",color:aqua},{text:" (",color:green,extra:["",{score:{name:"fishing.max",objective:board},color:"light_purple"},"分)"]}]
...
tag @a[tag=fishing.win] remove fishing.tobecalc
execute as @a[tag=fishing.win] run team leave @s
execute as @a[tag=fishing.win] run tellraw @s ["\u00a7d第三名（你）：",{selector:"@a[tag=fishing.win]",color:aqua},{text:" (",color:green,extra:["",{score:{name:"fishing.max",objective:board},color:"light_purple"},"分)"]}]
