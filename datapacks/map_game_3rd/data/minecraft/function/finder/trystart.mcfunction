...
execute if score finder.state state matches 1.. run return run function minecraft:finder/spec
...
execute if score wait.player tick matches 2.. run function minecraft:finder/start
