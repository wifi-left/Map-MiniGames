...
execute if score live.map board matches 0 run tp @s 217 -61 234 45 0
execute if score live.map board matches 1 run tp @s 162 -61 230 -45 0

execute at @s run playsound entity.generic.explode player @s ~ ~ ~ 1 1 1
clear @s *[custom_data~{live.equipment:1}]
function minecraft:live/items/handler

give @s wind_charge 8
