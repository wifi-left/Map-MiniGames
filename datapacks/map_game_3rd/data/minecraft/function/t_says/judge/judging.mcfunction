execute if score t_says.scene board matches 1 run function minecraft:t_says/scene/judging/jump_from_platform
execute if score t_says.scene board matches 8 run function minecraft:t_says/scene/judging/hugging_with_other
