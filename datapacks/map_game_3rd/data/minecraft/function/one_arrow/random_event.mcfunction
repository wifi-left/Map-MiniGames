...
execute if score random temp matches 1 run title @a[team=one_arrow] subtitle ["\u00a7f发光 6s"]
execute if score random temp matches 1 run effect give @a[team=one_arrow,gamemode=adventure] glowing 6 25 true
...
execute if score random temp matches 7 run title @a[team=one_arrow] subtitle ["\u00a7f发光 3s"]
execute if score random temp matches 7 run effect give @a[team=one_arrow,gamemode=adventure] glowing 3 25 true

execute if score random temp matches 8..10 run title @a[team=one_arrow] subtitle ["\u00a7f无事件"]