...
execute as @a[team=one_arrow,gamemode=adventure] run scoreboard players add wait.player tick 1


execute if score one_arrow.state state matches 1.. run return run function minecraft:one_arrow/spec
...
execute if score wait.player tick matches 2.. run function minecraft:one_arrow/start
