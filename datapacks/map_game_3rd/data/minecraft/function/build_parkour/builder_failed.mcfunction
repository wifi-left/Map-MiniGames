...
execute as @s[tag=build_parkour.builder] run give @a[tag=!build_parkour.builder,team=build_parkour] sunflower[max_stack_size=99,rarity=epic,item_name="金币",custom_data={"build_parkour":2}] 1
