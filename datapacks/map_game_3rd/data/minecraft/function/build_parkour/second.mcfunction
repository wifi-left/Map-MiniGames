...
execute if score build_parkour.state state matches 6 unless entity @a[gamemode=adventure,team=build_parkour] run function minecraft:build_parkour/round_over
...
execute if score build_parkour.state state matches 1..99 if score build_parkour.time board matches 30 run function minecraft:build_parkour/time_warning
execute if score build_parkour.state state matches 1..99 if score build_parkour.time board matches 15 run function minecraft:build_parkour/time_warning
execute if score build_parkour.state state matches 1..99 if score build_parkour.time board matches 1..5 run function minecraft:build_parkour/time_warning
