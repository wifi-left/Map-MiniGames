...
execute as @a[tag=build_parkour.win] run tellraw @s ["\u00a7a第一名（你）：",{selector:"@s",color:aqua},{text:" (",color:green,extra:["",{score:{name:"build_parkour.max",objective:board},color:"light_purple"},"分)"]}]
...
tag @a[tag=build_parkour.win] remove build_parkour.tobecalc
execute as @a[tag=build_parkour.win] run team leave @s
execute as @a[tag=build_parkour.win] run tellraw @s ["\u00a7e第二名（你）：",{selector:"@s",color:aqua},{text:" (",color:green,extra:["",{score:{name:"build_parkour.max",objective:board},color:"light_purple"},"分)"]}]
...
tag @a[tag=build_parkour.win] remove build_parkour.tobecalc
execute as @a[tag=build_parkour.win] run team leave @s
execute as @a[tag=build_parkour.win] run tellraw @s ["\u00a7d第三名（你）：",{selector:"@s",color:aqua},{text:" (",color:green,extra:["",{score:{name:"build_parkour.max",objective:board},color:"light_purple"},"分)"]}]
