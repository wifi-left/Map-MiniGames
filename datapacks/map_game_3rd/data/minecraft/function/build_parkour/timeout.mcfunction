...
execute if score build_parkour.state state matches 3 run return run function minecraft:build_parkour/builder_failed
execute if score build_parkour.state state matches 4 run return run function minecraft:build_parkour/builder_failed
execute if score build_parkour.state state matches 5 as @a[team=build_parkour,gamemode=adventure] run function minecraft:build_parkour/died
