...
execute unless items entity @s container.* quartz_stairs unless items entity @s player.cursor quartz_stairs unless items entity @s weapon.offhand quartz_stairs run clear @s quartz_stairs
execute unless items entity @s container.* quartz_stairs unless items entity @s player.cursor quartz_stairs unless items entity @s weapon.offhand quartz_stairs run give @s quartz_stairs[custom_data={"build_parkour":1},can_break={blocks:"#build_parkour/building_blocks_destroy"},can_place_on={blocks:"#build_parkour/building_blocks"},tooltip_display={hidden_components:["can_break","can_place_on"]}]

execute unless items entity @s container.* oak_fence unless items entity @s player.cursor oak_fence unless items entity @s weapon.offhand oak_fence run clear @s oak_fence
execute unless items entity @s container.* oak_fence unless items entity @s player.cursor oak_fence unless items entity @s weapon.offhand oak_fence run give @s oak_fence[custom_data={"build_parkour":1},can_break={blocks:"#build_parkour/building_blocks_destroy"},can_place_on={blocks:"#build_parkour/building_blocks"},tooltip_display={hidden_components:["can_break","can_place_on"]}]

execute unless items entity @s container.* big_dripleaf unless items entity @s player.cursor big_dripleaf unless items entity @s weapon.offhand big_dripleaf run clear @s big_dripleaf
execute unless items entity @s container.* big_dripleaf unless items entity @s player.cursor big_dripleaf unless items entity @s weapon.offhand big_dripleaf run give @s big_dripleaf[custom_data={"build_parkour":1},can_break={blocks:"#build_parkour/building_blocks_destroy"},can_place_on={blocks:"#build_parkour/building_blocks"},tooltip_display={hidden_components:["can_break","can_place_on"]}]
...
execute unless items entity @s container.* lever unless items entity @s player.cursor lever unless items entity @s weapon.offhand lever run clear @s lever
