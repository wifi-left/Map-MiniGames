...
execute if score random temp matches 15 run give @s bow[custom_data={disaster.snow:bomb_bow},max_damage=1]
execute if score random temp matches 16..17 run give @s snowball[item_model='fire_charge']
