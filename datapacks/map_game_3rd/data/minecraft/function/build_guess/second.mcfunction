...
execute if score build_guess.state state matches 3..5 if score build_guess.time board matches 1.. run title @a[team=build_guess,tag=build_guess.guesser,gamemode=adventure] actionbar ["\u00a7b倒计时：",{score:{objective:board,name:"build_guess.time"},color:gold},"\u00a76s\u00a78 | \u00a7b提示：",{nbt:"build_guess.tip",storage:"minecraft:temp",color:yellow,interpret:true}]
execute if score build_guess.state state matches 3..5 if score build_guess.time board matches 1.. run title @a[team=build_guess,tag=build_guess.builder,gamemode=adventure] actionbar ["\u00a7b倒计时：",{score:{objective:board,name:"build_guess.time"},color:gold},"\u00a76s\u00a78 | \u00a7b当前词汇：",{nbt:"build_guess.word",storage:"minecraft:temp",color:yellow,interpret:true}]
execute if score build_guess.state state matches 3..5 if score build_guess.time board matches 1.. run title @a[team=build_guess,gamemode=spectator] actionbar ["\u00a7b倒计时：",{score:{objective:board,name:"build_guess.time"},color:gold},"\u00a76s\u00a78 | \u00a7b当前词汇：",{nbt:"build_guess.word",storage:"minecraft:temp",color:yellow,interpret:true}]
