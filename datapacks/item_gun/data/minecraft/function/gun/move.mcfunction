...
execute if data entity @s {data:{guntype:hideseek_mace}} if score @s PSTJ matches 0.. at @s run function minecraft:gun/testfortarget_hideseek
execute if score @s PSTJ matches 0.. if data entity @s {data:{guntype:hideseek_mace}} if entity @a[team=hide.play.ani,tag=hitted] run function gun/hideseek_mace/hit
