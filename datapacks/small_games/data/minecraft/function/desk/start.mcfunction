...
execute if score desk.type board matches 2 run function minecraft:desk/russia/start
execute if score desk.type board matches 3 run function minecraft:merchant/start
