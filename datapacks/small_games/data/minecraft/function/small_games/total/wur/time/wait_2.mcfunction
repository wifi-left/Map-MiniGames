...
execute as @a[team=play.total,gamemode=adventure] unless items entity @s weapon.offhand *[custom_data~{"game_total":1}] run scoreboard players add total.unsel.count tick 1
