...
data modify storage minecraft:temp random_games_all.games append value {id:41,name:"\u00a7d一箭毙命",prefix:"[策略游戏]",desc:"活下去！小心老六！",state_var:"one_arrow.state state",start_func:["execute as @a[tag=play.total] run function one_arrow/join","function one_arrow/trystart"]}
...
data modify storage minecraft:temp random_games_all.games append value {id:42,name:"\u00a7d飞行大赛",prefix:"[休闲游戏]",desc:"更快飞到终点！~",state_var:"elytra.state state",start_func:["execute as @a[tag=play.total] run function elytra/join","function elytra/trystart"]}
...
data modify storage minecraft:temp random_games_all.games append value {id:43,name:"\u00a7b躲避球游戏",prefix:"[球类游戏]",desc:"简易版本的躲避球比赛！小心球！",state_var:"ballgame.state state",start_func:["execute as @a[tag=play.total] run function ballgame/join","scoreboard players set ballgame.type board 1","function ballgame/trystart"]}
