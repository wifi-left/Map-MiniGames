...
execute as @s[team=bw.green] if score bw.green.trap.1 board matches 1.. run scoreboard players set bw.buy.armor.need board 2
execute as @s[team=bw.green] if score bw.green.trap.2 board matches 1.. run scoreboard players set bw.buy.armor.need board 4
execute as @s[team=bw.red] if score bw.red.trap.1 board matches 1.. run scoreboard players set bw.buy.armor.need board 2
execute as @s[team=bw.red] if score bw.red.trap.2 board matches 1.. run scoreboard players set bw.buy.armor.need board 4
execute as @s[team=bw.yellow] if score bw.yellow.trap.1 board matches 1.. run scoreboard players set bw.buy.armor.need board 2
execute as @s[team=bw.yellow] if score bw.yellow.trap.2 board matches 1.. run scoreboard players set bw.buy.armor.need board 4
execute as @s[team=bw.blue] if score bw.blue.trap.1 board matches 1.. run scoreboard players set bw.buy.armor.need board 2
execute as @s[team=bw.blue] if score bw.blue.trap.2 board matches 1.. run scoreboard players set bw.buy.armor.need board 4
