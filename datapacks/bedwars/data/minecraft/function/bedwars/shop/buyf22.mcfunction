...
execute if score @s bw.tmp.gd matches 8.. run give @s stick[custom_name="\u00a7f击退棍",enchantments={"minecraft:knockback":2},tooltip_display={hidden_components:[enchantments,can_place_on,can_break]},can_place_on=[{blocks:"#minecraft:bwplace"}],can_break=[{blocks:"#minecraft:bedblocks"}]] 1
