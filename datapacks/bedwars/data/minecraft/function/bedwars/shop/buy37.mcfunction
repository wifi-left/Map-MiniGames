...
execute if score @s bw.tmp.dm matches 4.. if score @s bw.tmp.em matches 4.. run give @s mace[can_place_on=[{blocks:"#minecraft:bwplace"}],tooltip_display={hidden_components:[can_place_on,can_break]},can_break=[{blocks:"#minecraft:bedblocks"}]]
