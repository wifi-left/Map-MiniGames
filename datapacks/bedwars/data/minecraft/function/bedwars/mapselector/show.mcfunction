...
execute if score bw.mode board matches ..0 run data modify block -299 76 210 front_text.messages[2] set value '"\\u00a76[错误]"'
...
execute if score bw.mode board matches 6 run data modify block -299 76 210 front_text.messages[2] set value '"\\u00a7a四合院"'
