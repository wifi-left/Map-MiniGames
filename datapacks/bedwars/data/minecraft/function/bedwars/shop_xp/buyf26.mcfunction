...
execute if score @s xp matches 140.. run tellraw @s ["§a你购买了§6Iron Sword * 1"]
execute if score @s xp matches 140.. if score bw.buy.sharpness.tmp board matches 0 run give @s iron_sword[can_place_on=[{blocks:"#minecraft:bwplace"}],tooltip_display={hidden_components:[can_place_on,can_break]},can_break=[{blocks:"#minecraft:bedblocks"}]] 1
execute if score @s xp matches 140.. if score bw.buy.sharpness.tmp board matches 1 run give @s iron_sword[can_place_on=[{blocks:"#minecraft:bwplace"}],tooltip_display={hidden_components:[can_place_on,can_break]},can_break=[{blocks:"#minecraft:bedblocks"}],enchantments={sharpness:1}] 1
