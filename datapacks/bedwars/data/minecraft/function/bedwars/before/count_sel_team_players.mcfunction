...
execute as @a[team=bw.wait,tag=!GLOBAL.SPEC,scores={bw.team=4}] run scoreboard players add bw.green.1 tick 1
scoreboard players set bw.blue.1 tick 0
execute as @a[team=bw.wait,tag=!GLOBAL.SPEC,scores={bw.team=2}] run scoreboard players add bw.blue.1 tick 1
scoreboard players set bw.yellow.1 tick 0
execute as @a[team=bw.wait,tag=!GLOBAL.SPEC,scores={bw.team=3}] run scoreboard players add bw.yellow.1 tick 1
scoreboard players set bw.red.1 tick 0
execute as @a[team=bw.wait,tag=!GLOBAL.SPEC,scores={bw.team=1}] run scoreboard players add bw.red.1 tick 1
