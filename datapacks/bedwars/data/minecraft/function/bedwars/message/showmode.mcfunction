...
execute if score bw.mode state matches 3 run data modify block -305 76 210 front_text.messages[2] set value "\u00a7b四队 \u00a7d经验模式"
...
execute if score bw.mode state matches 7 run data modify block -305 76 210 front_text.messages[2] set value "\u00a7a两队 \u00a7d经验模式"
