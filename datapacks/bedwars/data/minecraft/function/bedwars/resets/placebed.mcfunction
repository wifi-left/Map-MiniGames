...
function minecraft:bedwars/resets/beds/blue
function minecraft:bedwars/resets/beds/green
function minecraft:bedwars/resets/beds/red
function minecraft:bedwars/resets/beds/yellow
