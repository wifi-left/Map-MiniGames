...
execute if score @s[tag=!bw.speed,team=bw.green] bw.tmp.dm matches 6.. run tellraw @a[team=bw.green] [{"selector":"@s"},"\u00a7a购买了\u00a76团队抗性加成"]
execute if score @s[tag=!bw.speed,team=bw.green] bw.tmp.dm matches 6.. run tag @a[team=bw.green] add bw.speed

execute if score @s[tag=!bw.speed,team=bw.red] bw.tmp.dm matches 6.. run tellraw @a[team=bw.red] [{"selector":"@s"},"\u00a7a购买了\u00a76团队抗性加成"]
execute if score @s[tag=!bw.speed,team=bw.red] bw.tmp.dm matches 6.. run tag @a[team=bw.red] add bw.speed

execute if score @s[tag=!bw.speed,team=bw.blue] bw.tmp.dm matches 6.. run tellraw @a[team=bw.blue] [{"selector":"@s"},"\u00a7a购买了\u00a76团队抗性加成"]
execute if score @s[tag=!bw.speed,team=bw.blue] bw.tmp.dm matches 6.. run tag @a[team=bw.blue] add bw.speed

execute if score @s[tag=!bw.speed,team=bw.yellow] bw.tmp.dm matches 6.. run tellraw @a[team=bw.yellow] [{"selector":"@s"},"\u00a7a购买了\u00a76团队抗性加成"]
