...
execute if entity @a[tag=sur.sel,limit=1] in overworld run item replace block 0 -64 0 container.0 with minecraft:compass[lodestone_tracker={target:{dimension:"minecraft:airworld",pos:[0,0,0]},tracked:0b},custom_name='"\\u00a7f玩家追踪指南针 \\u00a7c(请勿移动此物品)"',lore=['"\\u00a77默认追踪离你最近的玩家"']]

execute unless entity @a[tag=sur.sel,limit=1] in overworld run item replace block 0 -64 0 container.0 with minecraft:compass[lodestone_tracker={target:{dimension:"minecraft:airworld",pos:[0,0,0]},tracked:0b},custom_name='"\\u00a7f玩家追踪指南针 \\u00a78- \\u00a7c失去目标"',lore=['"\\u00a77默认追踪离你最近的玩家"']]
