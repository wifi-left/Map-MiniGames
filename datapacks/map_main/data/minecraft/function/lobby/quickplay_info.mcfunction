...
$data modify storage minecraft:temp dialog_tmp.actions append value {label:"§6[ID#§a$(id)§6] §$(color)$(name)",action:{type:"run_command",command:"/trigger quickplay set $(id)"}}
