...
function minecraft:lobby/quickplay_info {id:52,name:"灾难：雪灾",color:b}

function minecraft:lobby/quickplay_info {id:51,name:"绵羊突击队",color:d}
...
function minecraft:lobby/quickplay_info {id:53,name:"搭路练习",color:6}
