...
function minecraft:lobby/quickplay_info {id:8,name:"战桥",color:b}
function minecraft:lobby/quickplay_info {id:9,name:"高尔夫",color:b}
...
function minecraft:lobby/quickplay_info {id:13,name:"饥饿游戏",color:b}
function minecraft:lobby/quickplay_info {id:14,name:"职业战争",color:b}
function minecraft:lobby/quickplay_info {id:15,name:"密室杀手",color:b}
function minecraft:lobby/quickplay_info {id:16,name:"Live Longest",color:b}
function minecraft:lobby/quickplay_info {id:17,name:"关卡跑酷",color:b}
...
function minecraft:lobby/quickplay_info {id:21,name:"小游戏合集",color:b}
function minecraft:lobby/quickplay_info {id:22,name:"Snow",color:b}
function minecraft:lobby/quickplay_info {id:23,name:"TNT Wars",color:b}
function minecraft:lobby/quickplay_info {id:24,name:"Zombie Days（PVE）",color:b}
