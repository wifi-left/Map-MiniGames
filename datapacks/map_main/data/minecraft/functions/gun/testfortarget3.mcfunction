...
tag @s add selel
execute as @e[distance=0..7,limit=1,tag=pve.zombie,sort=nearest,tag=!hitted] at @s positioned ~-1 ~-1 ~-1 if entity @e[dx=7,dy=4,dz=7,tag=selel] run tag @s add hitted
