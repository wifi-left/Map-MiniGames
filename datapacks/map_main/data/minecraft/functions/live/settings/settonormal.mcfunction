data merge block 36 8 0 {Text2:"[{\"text\":\"\\u00a7a[\\u00a7bNormal Mode\\u00a7a]\",\"color\":\"aqua\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/function minecraft:live/settings/settoguess\"}}]",Text3:"[{\"text\":\"Guess Killer\",\"color\":\"gold\"}]"}
