...
execute if score twolf.state state matches 1.. as @s[team=wolfpeople] run function twolf/join
execute if score twolf.state state matches 1.. as @s[team=wait.wolfpeople] run function twolf/join
