...
## 
execute as @e[tag=pve.event.block.fruit] at @s run setblock ~ ~ ~ minecraft:sweet_berry_bush[age=2]
execute as @e[tag=pve.event.block.fruit,limit=12,sort=random] at @s run setblock ~ ~ ~ minecraft:sweet_berry_bush[age=3]
