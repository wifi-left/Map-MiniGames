...
execute as @s[tag=buy.pass] run give @s minecraft:carrot_on_a_stick[custom_data={hp:10,gun:4,bullet:100,cdtime:3},custom_name="\u00a7c火焰弹魔法棒",lore=["\u00a7b可使用次数：\u00a7e100","\u00a7bCD: \u00a7e30tick","\u00a7b伤害：\u00a77未知","\u00a7b技能: \u00a7a召唤火球","\u00a7c注意：此枪可能会伤害玩家","\u00a7b消耗能量：\u00a7e10"],custom_model_data={floats:[11f]}]
