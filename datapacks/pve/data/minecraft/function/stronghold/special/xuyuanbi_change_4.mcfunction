...
execute if score stronghold.tmp board matches ..299 run title @s actionbar ["\u00a7c金币不足"]
execute if score stronghold.tmp board matches ..299 run return 0
clear @s gold_ingot 300
