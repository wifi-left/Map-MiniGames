...
execute if score stronghold.difficuly board matches 1..2 run item replace entity @s hotbar.0 with iron_sword[item_name='蚀刻之刃']
execute if score stronghold.difficuly board matches 3.. run item replace entity @s hotbar.0 with stone_sword[item_name='蚀刻之刃']
