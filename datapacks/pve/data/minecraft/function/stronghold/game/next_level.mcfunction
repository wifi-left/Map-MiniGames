...
execute if score stronghold.difficulty board matches 0 run title @a[team=stronghold] subtitle [{text:"难度：",color:white},{"text":"自动选择","color":"yellow"}]
execute if score stronghold.difficulty board matches 1 run title @a[team=stronghold] subtitle [{text:"难度：",color:white},{"text":"简单","color":"green"}]
execute if score stronghold.difficulty board matches 2 run title @a[team=stronghold] subtitle [{text:"难度：",color:white},{"text":"普通","color":"aqua"}]
execute if score stronghold.difficulty board matches 3 run title @a[team=stronghold] subtitle [{text:"难度：",color:white},{"text":"困难","color":"red"}]
execute if score stronghold.difficulty board matches 4 run title @a[team=stronghold] subtitle [{text:"难度：",color:white},{"text":"逆天","color":"dark_red"}]
