...
execute as @a[team=lobby,tag=parkouring,gamemode=!creative] at @s as @s[y=-1,dy=-100] run function minecraft:npark/backpoint
execute as @a[team=lobby,tag=parkouring,gamemode=!spectator] at @s if block ~ ~ ~ heavy_weighted_pressure_plate run function minecraft:npark/setpoint
execute as @a[team=lobby,tag=parkouring,gamemode=!spectator] at @s if block ~ ~ ~ polished_blackstone_pressure_plate run function minecraft:npark/end
execute as @a[team=lobby,tag=parkouring,gamemode=!spectator] at @s if block ~ ~ ~ light_weighted_pressure_plate run function minecraft:npark/resettime
