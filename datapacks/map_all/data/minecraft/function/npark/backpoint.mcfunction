...
execute if score park.tmp board matches 1 in overworld run tp @s 191 115 -33 -180 0
execute if score park.tmp board matches 0 in overworld run function utils:tp with storage minecraft:temp tp_pos
