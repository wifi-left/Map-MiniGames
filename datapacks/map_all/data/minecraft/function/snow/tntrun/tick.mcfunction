...
## 
execute as @a[team=play.snow,gamemode=adventure] at @s unless entity @e[tag=snow.disa,distance=0..1] if block ~ ~-1 ~ #snowmineable run function minecraft:snow/tntrun/setsnow
