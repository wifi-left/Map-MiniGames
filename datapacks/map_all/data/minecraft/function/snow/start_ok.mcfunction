...
execute unless score snow.tntrun state matches 1..1 run schedule function minecraft:snow/final 80s replace
execute unless score snow.tntrun state matches 3 run schedule function minecraft:snow/final 80s replace
