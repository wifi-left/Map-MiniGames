...
execute if score snow.tntrun state matches 1..2 run scoreboard players set snow.state state 2
...
execute if score snow.tntrun state matches 3 run title @a[team=play.snow] title ["\u00a7c\u00a7l爆炸弓模式"]
