...
execute if score snow.mode board matches 1 run function minecraft:snow/map/smallvillage
execute if score snow.mode board matches 2 run function minecraft:snow/map/towner
execute if score snow.mode board matches 3 run function minecraft:snow/map/onlyone
execute if score snow.mode board matches 4 run function minecraft:snow/map/glass
