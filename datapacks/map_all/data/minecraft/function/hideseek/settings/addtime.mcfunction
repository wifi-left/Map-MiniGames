...
scoreboard players add hide2.timeperplayer board 5
execute if score hide2.timeperplayer board matches 91.. run tellraw @s ["§c时间过长。"]
execute if score hide2.timeperplayer board matches 91.. run scoreboard players set hide2.timeperplayer board 90
function minecraft:hideseek/settings/showtime
