...
scoreboard players remove hide2.glowgap board 5
execute if score hide2.glowgap board matches ..9 run tellraw @s ["§c时间过短。"]
execute if score hide2.glowgap board matches ..9 run scoreboard players set hide2.glowgap board 10
