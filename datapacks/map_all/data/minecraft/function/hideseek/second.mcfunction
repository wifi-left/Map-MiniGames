...
bossbar set minecraft:hideseek name ["\u00a7b剩余时间：",{"score":{"objective":"board","name":"hide.resttime"},"color":"gold"},"\u00a76s  \u00a7a剩余躲藏者数：",{"score":{"objective":"board","name":"hide.restanimals"},"color":"gold"}]
