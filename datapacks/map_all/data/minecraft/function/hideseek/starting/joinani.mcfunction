...
clear @s
give @s stick[unbreakable={},enchantments={"minecraft:knockback":3},custom_name="\u00a7bKB Stick"]
# item replace entity @s inventory.26 with arrow
give @s carrot_on_a_stick[unbreakable={},custom_data={ani:1},custom_name="\u00a7b模仿脚下方块\u00a77 - 右键点击",enchantments={"minecraft:knockback":3}]
