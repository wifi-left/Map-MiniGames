...
item replace entity @s armor.feet with leather_boots[unbreakable={},enchantments={levels:{"minecraft:binding_curse":1}},attribute_modifiers={modifiers:[{type:"movement_speed",slot:"feet",id:"1",name:"sd2",amount:0.02,operation:"add_value"}]}]
