...
data modify storage minecraft:temp random_games_all.games append value {id:23,name:"\u00a7a贪吃蛇",state_var:"sneak.state state",start_func:["execute as @a[tag=play.total] run function sneak/join","function sneak/trystart"]}
...
data modify storage minecraft:temp random_games_all.games append value {id:30,name:"\u00a7c掘一死战(爆炸弓版)",state_var:"snow.state state",start_func:["scoreboard players set snow.tntrun state 3","execute as @a[tag=play.total] run function snow/join","function snow/trystart"]}
data modify storage minecraft:temp random_games_all.games append value {id:29,name:"\u00a7a掘一死战+TNTRUN",state_var:"snow.state state",start_func:["scoreboard players set snow.tntrun state 2","execute as @a[tag=play.total] run function snow/join","function snow/trystart"]}
...
data modify storage minecraft:temp random_games_all.games append value {id:18,name:"\u00a7b饥饿游戏(大型游戏，适合多人)",state_var:"hunger.state state",start_func:["execute as @a[tag=play.total] run function hunger/join","function hunger/trystart"]}
data modify storage minecraft:temp random_games_all.games append value {id:15,name:"\u00a7a起床战争(大型游戏，适合多人)",state_var:"bw.state state",start_func:["execute as @a[tag=play.total] run function bedwars/message/join","function minecraft:bedwars/before/trystart"]}

data modify storage minecraft:temp random_games_all.games append value {id:26,name:"\u00a7b烽火燎原丶占点模式(大型游戏，适合多人)",state_var:"blaze.state state",start_func:["execute as @a[tag=play.total] run function blaze/join","scoreboard players set blaze.mode board 1","function blaze/trystart"]}

data modify storage minecraft:temp random_games_all.games append value {id:27,name:"\u00a7b烽火燎原丶团战模式(大型游戏，适合多人)",state_var:"blaze.state state",start_func:["execute as @a[tag=play.total] run function blaze/join","scoreboard players set blaze.mode board 2","function blaze/trystart"]}

data modify storage minecraft:temp random_games_all.games append value {id:28,name:"\u00a7b烽火燎原丶警匪模式(大型游戏，适合多人)",state_var:"blaze.state state",start_func:["execute as @a[tag=play.total] run function blaze/join","scoreboard players set blaze.mode board 3","function blaze/trystart"]}

data modify storage minecraft:temp random_games_all.games append value {id:19,name:"\u00a79生存游戏(大型游戏，适合多人)",state_var:"sur.state state",start_func:["execute as @a[tag=play.total] run function surgame:join","function surgame:trystart"]}
...
data modify storage minecraft:temp random_games_all.games append value {id:25,name:"\u00a7d赛猪(体验感较差)",state_var:"car.state state",start_func:["execute as @a[tag=play.total] run function minecraft:car_race/join","function car_race/teststart"]}
...
data modify storage minecraft:temp random_games_all.games append value {id:24,name:"\u00a76船战(废案)",state_var:"btw.state state",start_func:["execute as @a[tag=play.total] run function minecraft:boatwars/join","function boatwars/trystart"]}
