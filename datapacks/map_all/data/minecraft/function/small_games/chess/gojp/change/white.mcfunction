...
execute if score chess.tmp board matches 1.. run fill 81 120 62 67 120 48 white_stained_glass replace lime_stained_glass
execute if score chess.tmp board matches 0 run fill 81 120 62 67 120 48 black_stained_glass replace lime_stained_glass
