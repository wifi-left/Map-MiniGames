...
execute if score hunger.chests board matches ..0 run bossbar set minecraft:hungergame max 60
execute if score hunger.chests board matches ..0 run scoreboard players set hunger.time board 60
