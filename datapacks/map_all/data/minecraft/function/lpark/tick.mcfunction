...
execute as @a[team=parkour] at @s if block ~ ~-1 ~ loom run effect give @s levitation 1 25 true
execute as @a[team=parkour] at @s if block ~ ~-1 ~ loom run playsound entity.ender_dragon.flap block @s ~ ~ ~ 1 1 1