...
tellraw @a [{"selector":"@s"},{text:" 完成了[",color:aqua},{text:"大厅迷宫",color:gold},{text:"]",color:aqua}]
...
execute if score @s parkour.second matches 10.. if score @s parkour.stick matches ..9 run tellraw @a [{"selector":"@s"},"§b§l 的迷宫用时：§e[",{"score":{"name":"@s","objective":"parkour.minute"},"color":"yellow"},"§e:",{"score":{"name":"@s","objective":"parkour.second"},"color":"yellow"},"§e.0",{"score":{"name":"@s","objective":"parkour.stick"},"color":"yellow"},"§e]"]
tellraw @a [""]
