...
execute as @a[team=lobby,tag=mazing,gamemode=!spectator] at @s if block ~ ~ ~ crimson_pressure_plate run function minecraft:maze/end
execute as @a[team=lobby,tag=mazing,gamemode=!spectator] at @s if block ~ ~ ~ warped_pressure_plate run function minecraft:maze/resettime
