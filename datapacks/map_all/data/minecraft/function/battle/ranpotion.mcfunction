...
summon armor_stand 157 36 -340 {Tags:["battle.ranpotion"],CustomName:["药水"],CustomNameVisible:1b,Invulnerable:1b,Silent:1b,NoGravity:1b,Invisible:true,NoBasePlate:true,DisabledSlots:2039583}
