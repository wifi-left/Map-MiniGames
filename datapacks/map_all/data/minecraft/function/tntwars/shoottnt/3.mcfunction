...
execute as @s at @s in overworld positioned 0.0 0.0 0.0 run summon marker ^ ^ ^3 {Tags:["t.tmp"]}
execute anchored eyes run summon creeper ^ ^ ^1 {Tags:["t.new","tntwars.tnt"],ignited:1b,Fuse:60s}
tag @s add t.t.tmp
