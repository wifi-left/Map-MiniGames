...
execute as @a[team=pw.play,gamemode=adventure] run item replace entity @s armor.feet with leather_boots[enchantments={"minecraft:binding_curse":1,"minecraft:frost_walker":1},tooltip_display={hidden_components:[enchantments,unbreakable]},unbreakable={},dyed_color=1105614] 1
execute as @a[team=pw.play,gamemode=adventure] run item replace entity @s container.0 with stick[enchantments={"minecraft:knockback":2},tooltip_display={hidden_components:[enchantments,unbreakable]},unbreakable={},dyed_color=1105614] 1
