...
give @a[team=play.live.killer] minecraft:bow[unbreakable={},custom_name=["§aR§ba§ci§dn §eB§fo§6w"],lore=[["§aR§ba§ci§dn §eB§fo§6w"],["§aR§ba§ci§dn §eB§fo§6w"],["§aR§ba§ci§dn §eB§fo§6w"]],enchantments={"minecraft:power":2s}] 1
