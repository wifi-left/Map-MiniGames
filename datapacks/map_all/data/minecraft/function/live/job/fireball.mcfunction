...
item replace entity @s container.0 with minecraft:red_dye[tooltip_display={hidden_components:[unbreakable,enchantments,attribute_modifiers]},unbreakable={},custom_name=["§4Red §bSword"],lore=[["§c5 HP"]],enchantments={"minecraft:unbreaking":1},attribute_modifiers=[{type:"attack_damage",slot:mainhand,id:"uuid_4894794278636495",amount:5d,operation:"add_value"},{type:"attack_speed",slot:"mainhand",id:"uuid_1145514511455145",amount:-2.2,operation:"add_value"}]] 1
give @s minecraft:snowball[enchantments={"minecraft:unbreaking":1},tooltip_display={hidden_components:[enchantments]},custom_name="\u00a74\u00a7lFIREBALL",lore=["\u00a7b小心！火球可能会误伤你"]] 4
