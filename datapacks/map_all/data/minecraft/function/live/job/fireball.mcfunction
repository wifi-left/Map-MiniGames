...
item replace entity @s container.0 with minecraft:red_dye[unbreakable={show_in_tooltip:false},custom_name='["§4Red §bSword"]',lore=['["§c5 HP"]'],enchantments={levels:{"minecraft:unbreaking":1},show_in_tooltip:false},attribute_modifiers={modifiers:[{type:"attack_damage",slot:mainhand,id:"uuid_4894794278636495",amount:5d,operation:"add_value"},{type:"attack_speed",slot:"mainhand",id:"uuid_1145514511455145",amount:-2.2,operation:"add_value"}],show_in_tooltip:false}] 1
