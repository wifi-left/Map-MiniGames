...
item replace entity @s armor.feet with minecraft:leather_boots[dyed_color={rgb:16039255},unbreakable={},enchantment_glint_override=true]
item replace entity @s armor.legs with minecraft:leather_leggings[dyed_color={rgb:16039255},unbreakable={},enchantment_glint_override=true]
item replace entity @s container.0 with minecraft:carrot_on_a_stick[custom_data={job:1},custom_name='"\\u00a72\\u00a7l古老的剑"',lore=['"\\u00a7b右键释放剑气"'],unbreakable={show_in_tooltip:false},enchantments={levels:{"minecraft:unbreaking":1},show_in_tooltip:false},attribute_modifiers={modifiers:[{type:"attack_damage",slot:mainhand,id:"uuid_4894794278636495",amount:2d,operation:"add_value"},{type:"attack_speed",slot:"mainhand",id:"uuid_1145514511455145",amount:-2.4,operation:"add_value"}],show_in_tooltip:false},custom_model_data={floats:[3f]}] 1
