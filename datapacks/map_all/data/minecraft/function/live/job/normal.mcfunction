...
item replace entity @s container.0 with minecraft:iron_sword[unbreakable={show_in_tooltip:false},custom_name='["§6Golden §rIron §bSword"]',lore=['["§f7§c♥"]'],attribute_modifiers={modifiers:[{type:"attack_damage",slot:mainhand,id:"uuid_4894794278636495",amount:7d,operation:"add_value"},{type:"attack_speed",slot:"mainhand",id:"uuid_1145514511455145",amount:-2.4,operation:"add_value"}],show_in_tooltip:false}] 1
