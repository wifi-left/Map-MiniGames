...
item replace entity @s container.0 with minecraft:potato[unbreakable={},item_name={text:"洋芋",color:aqua,shadow_color:[1,0.25,1,0.7]},attribute_modifiers=[{id:"a",type:"attack_damage",amount:1.5,slot:"any",operation:"add_value"},{id:"a",type:"attack_speed",amount:-2.7,slot:"any",operation:"add_value"}]]
