...
## 
give @s wooden_sword[unbreakable={},attribute_modifiers={modifiers:[{type:"generic.attack_damage",slot:mainhand,uuid:[4894,7942,7863,6495],name:"noName",amount:7d,operation:"add_value"}]}]
...
item replace entity @s armor.feet with leather_boots[unbreakable={},enchantments={levels:{"minecraft:binding_curse":1}},attribute_modifiers={modifiers:[{type:"generic.movement_speed",slot:"feet",uuid:[1233,2233,233,233],name:"sd2",amount:0.02,operation:"add_value"}]}]
