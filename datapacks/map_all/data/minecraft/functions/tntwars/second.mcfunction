...
execute as @a[team=play.tntwars,tag=tntwars.a] run title @s actionbar ["\u00a7a「队伍A」\u00a7c你的队友：",{"selector":"@a[tag=tntwars.a]"}]
execute as @a[team=play.tntwars,tag=tntwars.b] run title @s actionbar ["\u00a7b「队伍B」\u00a7c你的队友：",{"selector":"@a[tag=tntwars.b]"}]
