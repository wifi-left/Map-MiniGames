...
give @s minecraft:potion{CustomPotionEffects:[{Id:10,Duration:200,Amplifier:1b,Ambient:0b,ShowParticles:0b},{Id:22,Duration:2000,Amplifier:1b,Ambient:0b,ShowParticles:0b}],display:{Name:'"\\u00a7c恢复药水"'},CustomPotionColor:14365954} 2