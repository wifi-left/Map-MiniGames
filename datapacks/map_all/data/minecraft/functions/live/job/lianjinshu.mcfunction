...
give @s minecraft:potion[potion_contents={custom_effects:[{id:"regeneration",duration:200,amplifier:1b,ambient:false,show_particles:false},{id:"absorption",duration:2000,amplifier:1b,ambient:false,show_particles:false}],custom_color:14365954},custom_name='"\\u00a7c恢复药水"']
