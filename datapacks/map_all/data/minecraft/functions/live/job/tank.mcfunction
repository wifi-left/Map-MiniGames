## ok?
item replace entity @s armor.chest with diamond_chestplate{Unbreakable:1b,HideFlags:63,Enchantments:[{id:"minecraft:protection",lvl:1s}],AttributeModifiers:[{AttributeName:"generic.movement_speed",Name:"noName",Amount:-0.03d,Operation:0,UUID:[I;1693,9851,4672,6648]}]}
