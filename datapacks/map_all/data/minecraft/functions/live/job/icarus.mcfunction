...
item replace entity @s weapon.offhand with minecraft:crossbow[enchantments={levels:{"minecraft:quick_charge":1}},custom_name='["§9伊卡洛斯之弩"]']
item replace entity @s weapon.mainhand with minecraft:wooden_sword[unbreakable={},enchantments={levels:{"minecraft:knockback":2}},custom_name='["§c伊卡洛斯之剑"]']
give @s arrow
