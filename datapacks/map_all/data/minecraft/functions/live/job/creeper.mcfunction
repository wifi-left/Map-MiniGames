...
# give @s minecraft:creeper_spawn_egg{EntityTag:{id:"minecraft:creeper",CustomName:'["CREEPER"]',CustomNameVisible:1b,Invulnerable:1b,Silent:1b,PersistenceRequired:1b,Glowing:1b,powered:true,ignited:true,ExplosionRadius:2b,fuse:30s},display:{Name:'"\\u00a72\\u00a7lCreeper"',Lore:['"\\u00a7b小心！他可能会误伤你"']},CanPlaceOn:["#minecraft:bwplace"],HideFlags:63} 3
