...
data merge block 133 -40 86 {Text1:'[{"selector":"@a[tag=hunger.sel]","color":"aqua"},"\\u00a7a 的背包"]'}
team join hunger @s
...
data modify entity @e[limit=1,type=item,tag=hunger.loot.new] Item.tag.display.Name set from block 133 -40 86 Text1
data modify entity @e[limit=1,type=item,tag=hunger.loot.new] CustomName set from block 133 -40 86 Text1
