...
execute if score chess.state state matches 1..1 if score chess.players board matches ..1 run function small_games/chess/boom/win/sthwrong
...
execute if score chess.state state matches 1..1 if score chess.players.black board matches ..0 run function small_games/chess/boom/win/white
...
execute if score chess.state state matches 1..1 if score chess.players.white board matches ..0 run function small_games/chess/boom/win/black
...
execute if score chess.countdown board matches ..0 run function small_games/chess/boom/turn/timeout
