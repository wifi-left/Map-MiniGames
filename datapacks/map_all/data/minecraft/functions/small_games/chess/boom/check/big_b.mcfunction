...
execute if score boom.tmp.idx1 board matches 0 if score boom.tmp.idx2 board matches 0 positioned 75 106 56 run function minecraft:small_games/chess/boom/check/bigcheck2_b
