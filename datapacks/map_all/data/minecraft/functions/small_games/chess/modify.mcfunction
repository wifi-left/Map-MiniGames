...
execute if score chest.type board matches 3 run data merge block 90 126 19 {Text2:'"\\u00a7d\\u00a7l[围棋(Alpha)]"'}
execute if score chest.type board matches 4 run data merge block 90 126 19 {Text2:'"\\u00a7e\\u00a7l[黑白棋]"'}
# execute if score chest.type board matches 2 run data merge block 90 126 19 {Text2:'"\\u00a7b\\u00a7l[爆炸棋(Alpha)]"'}