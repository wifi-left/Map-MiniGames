...
execute as @a[team=pw.play,gamemode=adventure] at @s if block ~ ~ ~ air if block ~ ~1 ~ air if score @s drown matches ..119 run scoreboard players add @s drown 1
execute as @a[team=pw.play,gamemode=adventure] at @s if block ~ ~ ~ air if block ~ ~1 ~ air if score @s drown matches ..119 run title @s actionbar ["\u00a7d\u00a7l您正在休息... ",{"score":{"objective": "drown","name": "@s"},"color": "aqua"}," \u00a76/ \u00a7a200"]
...
execute as @a[team=pw.play,gamemode=adventure] at @s if block ~ ~ ~ air if block ~ ~1 ~ air if score @s drown matches 120 run title @s actionbar ["\u00a7a\u00a7l您当前非常健康！ "]
execute as @a[team=pw.play,gamemode=adventure] at @s if block ~ ~ ~ water if score @s drown matches 50.. run title @s actionbar ["\u00a7e\u00a7l请注意您的体力 ",{"score":{"objective": "drown","name": "@s"},"color": "red"},"\u00a76 / \u00a7a200"]
execute as @a[team=pw.play,gamemode=adventure] at @s if block ~ ~ ~ water if score @s drown matches ..49 run title @s actionbar ["\u00a7c\u00a7l您感觉有点累 ",{"score":{"objective": "drown","name": "@s"},"color": "red"},"\u00a76 / \u00a7a200"]
