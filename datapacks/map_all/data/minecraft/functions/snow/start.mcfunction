...
execute unless score snow.tntrun state matches 2 run title @a[team=play.snow] title ["\u00a7e\u00a7l混合模式（掘一死战 + TNTRUN）"]
execute unless score snow.tntrun state matches 0 run title @a[team=play.snow] title ["\u00a7b\u00a7l掘一死战"]
