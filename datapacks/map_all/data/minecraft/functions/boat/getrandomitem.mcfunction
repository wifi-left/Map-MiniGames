...
execute if entity @e[tag=boat.sel,tag=1] run give @s carrot_on_a_stick{Unbreakable:1b,display:{Name:'"\\u00a7a\\u00a7l失明陷阱 \\u00a77- 右键使用"'},boatItem:4b,trap:1}
execute if entity @e[tag=boat.sel,tag=2] run give @s carrot_on_a_stick{Unbreakable:1b,display:{Name:'"\\u00a7c\\u00a7l下车陷阱 \\u00a77- 右键使用"'},boatItem:4b,trap:2}
