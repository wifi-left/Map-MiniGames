...
execute if score boat.type board matches ..1 run data merge block -12 146 -32 {Text3:'"\\u00a7b[冰船]"'}

# execute if score chest.type board matches 2 run data merge block 347 91 22 {Text2:'"\\u00a7b\\u00a7l[逃离神庙]"'}
execute if score boat.type board matches 2 run data merge block -12 146 -32 {Text3:'"\\u00a7d[猪]"'}
execute if score boat.type board matches 3 run data merge block -12 146 -32 {Text3:'"\\u00a7c[炽足兽]"'}
execute if score boat.type board matches 4 run data merge block -12 146 -32 {Text3:'"\\u00a77[无载具]"'}
execute if score boat.type board matches 5 run data merge block -12 146 -32 {Text3:'"\\u00a7e[赛马]"'}
