...
execute as @a[team=boat] at @s run playsound minecraft:entity.player.levelup player @s -62 160 -98 5 1 1
execute as @a[team=boat] at @s run playsound minecraft:block.note_block.pling player @s -62 160 -98 5 2 1
