...
execute as @s[tag=buy.pass] run give @s minecraft:carrot_on_a_stick[custom_data={hp:2,gun:1,bullet:200,cdtime:10,speed:1},custom_name='"\\u00a7a基础魔法棒"',lore=['"\\u00a7b可使用次数：\\u00a7e200"','"\\u00a7bCD: \\u00a7e10tick"','"\\u00a7b伤害：\\u00a7e3.0 HP"','"\\u00a7b消耗能量：\\u00a7e2"'],custom_model_data=9]
