...
execute as @s[tag=buy.pass] run give @s minecraft:carrot_on_a_stick[custom_data={hp:1,gun:2,bullet:800,cdtime:1,speed:2},custom_name='"\\u00a7c火属性魔法棒"',lore=['"\\u00a7b可使用次数：\\u00a7e800"','"\\u00a7bCD: \\u00a7e3tick"','"\\u00a7b伤害：\\u00a7e3.0 HP"','"\\u00a7b消耗能量：\\u00a7e1"'],custom_model_data=7]
