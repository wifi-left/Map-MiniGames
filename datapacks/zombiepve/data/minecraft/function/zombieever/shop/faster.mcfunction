...
execute as @s[tag=buy.pass] run give @s minecraft:carrot_on_a_stick[custom_data={hp:1,gun:1,bullet:1000,cdtime:3,speed:3},custom_name='"\\u00a7d莱福魔法棒"',lore=['"\\u00a7b可使用次数：\\u00a7e1000"','"\\u00a7bCD: \\u00a7e6tick"','"\\u00a7b伤害：\\u00a7e3.0 HP"','"\\u00a7b消耗能量：\\u00a7e1"'],custom_model_data={floats:[9f]}]
