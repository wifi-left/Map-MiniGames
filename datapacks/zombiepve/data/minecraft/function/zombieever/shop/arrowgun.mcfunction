...
execute as @s[tag=buy.pass] run give @s minecraft:carrot_on_a_stick[custom_data={hp:10,gun:6,bullet:400,cdtime:10},custom_name='"\\u00a76潜影贝枪"',lore=['"\\u00a7b子弹数量：\\u00a7e400"','"\\u00a7bCD: \\u00a7e10tick"','"\\u00a7b伤害：\\u00a7e视情况而定"'],custom_model_data=10]
