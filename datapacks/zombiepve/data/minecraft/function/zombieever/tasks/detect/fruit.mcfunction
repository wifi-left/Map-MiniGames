...
execute if score tmp board matches 18.. as @a[team=play.zombie,gamemode=adventure] at @s run give @s carrot_on_a_stick[custom_name='"\\u00a7e一小袋金币 \\u00a77- 右键使用"',custom_data={coin:1000,gun:-10},custom_model_data={floats:[21f]}] 1
