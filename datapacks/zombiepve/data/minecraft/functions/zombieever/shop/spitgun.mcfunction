...
execute as @s[tag=buy.pass] run give @s minecraft:carrot_on_a_stick[custom_data={gun:6,bullet:10,cdtime:10},custom_name='"\\u00a7dAOE魔法棒"',lore=['"\\u00a7b可使用次数：\\u00a7e10"','"\\u00a7bCD: \\u00a7e10tick"','"\\u00a7b伤害：\\u00a7e10\\u00a7b/zombie"','"\\u00a7b技能: \\u00a7aAOE 范围伤害 (10 Blocks)"'],custom_model_data=12]
