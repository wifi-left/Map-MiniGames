...
execute as @s[tag=buy.pass] run give @s minecraft:carrot_on_a_stick{gun:6,bullet:500,cdtime:10,display:{Name:'"\\u00a7d唾沫枪"',Lore:['"\\u00a7b子弹数量：\\u00a7e500"','"\\u00a7bCD: \\u00a7e10tick"','"\\u00a7b伤害：\\u00a77未知"','"\\u00a7b技能: \\u00a7a召唤唾沫星子"']},CustomModelData:12}
