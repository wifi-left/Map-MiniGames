...
execute as @s[tag=buy.pass] run give @s minecraft:carrot_on_a_stick{hp:1,gun:1,bullet:1000,cdtime:3,display:{Name:'"\\u00a7d莱福魔法棒"',Lore:['"\\u00a7b可使用次数：\\u00a7e1000"','"\\u00a7bCD: \\u00a7e6tick"','"\\u00a7b伤害：\\u00a7e3.0 HP"','"\\u00a7b消耗能量：\\u00a7e1"']},CustomModelData:9}
