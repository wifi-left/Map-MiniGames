...
execute as @s[tag=buy.pass] run give @s minecraft:carrot_on_a_stick{gun:1,bullet:500,cdtime:6,display:{Name:'"\\u00a7dFaster"',Lore:['"\\u00a7b子弹数量：\\u00a7e500"','"\\u00a7bCD: \\u00a7e6tick"','"\\u00a7b伤害：\\u00a7e3.0 HP"']}}
