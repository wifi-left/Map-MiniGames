...
execute as @s[tag=buy.pass] run give @s iron_helmet{Unbreakable:1b} 1
execute as @s[tag=buy.pass] run give @s iron_chestplate{Unbreakable:1b} 1
execute as @s[tag=buy.pass] run give @s iron_leggings{Unbreakable:1b} 1
execute as @s[tag=buy.pass] run give @s iron_boots{Unbreakable:1b} 1
