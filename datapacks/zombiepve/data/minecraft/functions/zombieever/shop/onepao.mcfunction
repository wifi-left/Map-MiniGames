...
execute as @s[tag=buy.pass] run give @s minecraft:carrot_on_a_stick{hp:10,gun:"pao",damage:500,bullet:50,cdtime:80,distance:80,display:{Name:'"\\u00a7a\\u00a7l电磁炮"',Lore:['"\\u00a7b可使用次数：\\u00a7e50"','"\\u00a7bCD: \\u00a7e80tick"','"\\u00a7b伤害：\\u00a7e50.0 HP"','"\\u00a7b距离：\\u00a7e80 \\u00a7bblocks"','"\\u00a7b消耗能量：\\u00a7e10"']},CustomModelData:9}
