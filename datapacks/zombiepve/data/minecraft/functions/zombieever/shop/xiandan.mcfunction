...
execute as @s[tag=buy.pass] run give @s minecraft:carrot_on_a_stick{gun:7,bullet:400,cdtime:20,distance:30,display:{Name:'"\\u00a7b霰弹枪"',Lore:['"\\u00a7b子弹数量：\\u00a7e400"','"\\u00a7bCD: \\u00a7e80tick"','"\\u00a7b伤害：\\u00a7e3.0 HP"','"\\u00a7b距离：\\u00a7e30 \\u00a7bblocks"']},CustomModelData:8}
