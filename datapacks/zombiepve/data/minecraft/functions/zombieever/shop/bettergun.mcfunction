...
execute as @s[tag=buy.pass] run give @s minecraft:carrot_on_a_stick{gun:"custom",damage:100,bullet:140,cdtime:30,distance:30,display:{Name:'"\\u00a7b李他娘的意大利炮"',Lore:['"\\u00a7b子弹数量：\\u00a7e140"','"\\u00a7bCD: \\u00a7e30tick"','"\\u00a7b伤害：\\u00a7e10.0 HP"']}}
