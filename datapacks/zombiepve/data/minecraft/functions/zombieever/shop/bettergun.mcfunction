...
execute as @s[tag=buy.pass] run give @s minecraft:carrot_on_a_stick{gun:"pao",damage:300,bullet:80,cdtime:80,distance:80,display:{Name:'"\\u00a7b李他娘的意大利炮"',Lore:['"\\u00a7b子弹数量：\\u00a7e80"','"\\u00a7bCD: \\u00a7e80tick"','"\\u00a7b伤害：\\u00a7e30.0 HP"','"\\u00a7b距离：\\u00a7e80 \\u00a7bblocks"']},CustomModelData:9}
