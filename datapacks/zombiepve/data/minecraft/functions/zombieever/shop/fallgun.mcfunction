...
execute as @s[tag=buy.pass] run give @s minecraft:carrot_on_a_stick{hp:3,gun:3,bullet:1000,cdtime:3,display:{Name:'"\\u00a7b反重力魔法棒"',Lore:['"\\u00a7b可使用次数：\\u00a7e1000"','"\\u00a7bCD: \\u00a7e10tick"','"\\u00a7b伤害：\\u00a7e3.0 HP"','"\\u00a7b消耗能量：\\u00a7e3"']},CustomModelData:8}
