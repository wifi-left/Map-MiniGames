...
execute as @s[tag=buy.pass] run give @s minecraft:carrot_on_a_stick{gun:3,bullet:400,cdtime:20,display:{Name:'"\\u00a7b反重力炮"',Lore:['"\\u00a7b子弹数量：\\u00a7e400"','"\\u00a7bCD: \\u00a7e10tick"','"\\u00a7b伤害：\\u00a7e3.0 HP"']}}
