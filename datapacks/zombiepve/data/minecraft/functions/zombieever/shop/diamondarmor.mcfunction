...
execute as @s[tag=buy.pass] run give @s diamond_helmet[unbreakable={}]
execute as @s[tag=buy.pass] run give @s diamond_chestplate[unbreakable={}]
execute as @s[tag=buy.pass] run give @s diamond_leggings[unbreakable={}]
execute as @s[tag=buy.pass] run give @s diamond_boots[unbreakable={}]
