...
execute as @a[team=play.zombie] run execute if score zombie.round board matches 25 as @e[tag=zombie.spawn.now,sort=random,limit=1] at @s run summon pillager ~ ~ ~ {Tags:["pve.zombie"],DeathLootTable:"",PersistenceRequired:1b,Attributes:[{Base:30d,Name:"generic.max_health"}],Health:60f,HandItems:[{id:"minecraft:diamond_axe",Count:1b},{}]}
execute as @a[team=play.zombie] run execute if score zombie.round board matches 25 as @e[tag=zombie.spawn.now,sort=random,limit=5] at @s run summon vindicator ~ ~ ~ {Tags:["pve.zombie"],DeathLootTable:"",PersistenceRequired:1b,Attributes:[{Base:30d,Name:"generic.max_health"}],Health:60f,HandItems:[{id:"minecraft:diamond_axe",Count:1b},{}]}
