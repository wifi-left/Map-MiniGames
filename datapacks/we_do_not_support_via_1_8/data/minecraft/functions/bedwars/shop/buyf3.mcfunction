...
execute if score @s bw.tmp.ir matches 24.. run give @s end_stone[can_place_on={predicates:[{blocks:["#minecraft:bwplace"]}],show_in_tooltip:false},can_break={predicates:[{blocks:["#minecraft:bedblocks"]}],show_in_tooltip:false}]
