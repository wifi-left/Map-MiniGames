...
execute if score @s bw.tmp.gd matches 12.. run give @s bow[unbreakable={show_in_tooltip:false},can_place_on={predicates:[{blocks:["#minecraft:bwplace"]}],show_in_tooltip:false},can_break={predicates:[{blocks:["#minecraft:bedblocks"]}],show_in_tooltip:false}]
