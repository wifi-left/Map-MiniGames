...
execute if score @s bw.tmp.gd matches 8.. run give @s stick[custom_name='"\\u00a7f击退棍"',enchantments={levels:{"minecraft:knockback":1},show_in_tooltip:false},can_place_on={predicates:[{blocks:["#minecraft:bwplace"]}],show_in_tooltip:false},can_break={predicates:[{blocks:["#minecraft:bedblocks"]}],show_in_tooltip:false}]
