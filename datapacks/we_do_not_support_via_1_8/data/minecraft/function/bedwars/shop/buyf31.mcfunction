...
execute if score @s bw.tmp.em matches 3.. run give @s bow[enchantments={"minecraft:power":1s,"minecraft:punch":1s},tooltip_display={hidden_components:[enchantments,unbreakable,can_place_on,can_break]},unbreakable={},can_place_on=[{blocks:"#minecraft:bwplace"}],can_break=[{blocks:"#minecraft:bedblocks"}]] 1
