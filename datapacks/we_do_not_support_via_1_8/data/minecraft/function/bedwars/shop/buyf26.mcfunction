...
execute if score @s bw.tmp.gd matches 7.. if score bw.buy.sharpness.tmp board matches 0 run give @s iron_sword[can_place_on={predicates:[{blocks:"#minecraft:bwplace"}],show_in_tooltip:false},can_break={predicates:[{blocks:"#minecraft:bedblocks"}],show_in_tooltip:false}] 1
execute if score @s bw.tmp.gd matches 7.. if score bw.buy.sharpness.tmp board matches 1 run give @s iron_sword[can_place_on={predicates:[{blocks:"#minecraft:bwplace"}],show_in_tooltip:false},can_break={predicates:[{blocks:"#minecraft:bedblocks"}],show_in_tooltip:false},enchantments={sharpness:1}] 1
