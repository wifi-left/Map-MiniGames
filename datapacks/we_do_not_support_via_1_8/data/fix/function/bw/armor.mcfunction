...
execute if score bw.sharpness.blue board matches 0 run give @a[tag=bwneeds,gamemode=!spectator,tag=bw.play,team=bw.blue] minecraft:wooden_sword[custom_data={bw:1},unbreakable={show_in_tooltip:false},can_break={predicates:[{blocks:"#minecraft:bedblocks"}],show_in_tooltip:false},can_place_on={predicates:[{blocks:"#minecraft:bwplace"}],show_in_tooltip:false}] 1
execute if score bw.sharpness.yellow board matches 0 run give @a[tag=bwneeds,gamemode=!spectator,tag=bw.play,team=bw.yellow] minecraft:wooden_sword[custom_data={bw:1},unbreakable={show_in_tooltip:false},can_break={predicates:[{blocks:"#minecraft:bedblocks"}],show_in_tooltip:false},can_place_on={predicates:[{blocks:"#minecraft:bwplace"}],show_in_tooltip:false}] 1

execute if score bw.sharpness.green board matches 1 run give @a[tag=bwneeds,gamemode=!spectator,tag=bw.play,team=bw.green] minecraft:wooden_sword[custom_data={bw:1},unbreakable={show_in_tooltip:false},can_break={predicates:[{blocks:"#minecraft:bedblocks"}],show_in_tooltip:false},can_place_on={predicates:[{blocks:"#minecraft:bwplace"}],show_in_tooltip:false},enchantments={"sharpness":1}] 1
execute if score bw.sharpness.red board matches 1 run give @a[tag=bwneeds,gamemode=!spectator,tag=bw.play,team=bw.red] minecraft:wooden_sword[custom_data={bw:1},unbreakable={show_in_tooltip:false},can_break={predicates:[{blocks:"#minecraft:bedblocks"}],show_in_tooltip:false},can_place_on={predicates:[{blocks:"#minecraft:bwplace"}],show_in_tooltip:false},enchantments={"sharpness":1}] 1
execute if score bw.sharpness.blue board matches 1 run give @a[tag=bwneeds,gamemode=!spectator,tag=bw.play,team=bw.blue] minecraft:wooden_sword[custom_data={bw:1},unbreakable={show_in_tooltip:false},can_break={predicates:[{blocks:"#minecraft:bedblocks"}],show_in_tooltip:false},can_place_on={predicates:[{blocks:"#minecraft:bwplace"}],show_in_tooltip:false},enchantments={"sharpness":1}] 1
execute if score bw.sharpness.yellow board matches 1 run give @a[tag=bwneeds,gamemode=!spectator,tag=bw.play,team=bw.yellow] minecraft:wooden_sword[custom_data={bw:1},unbreakable={show_in_tooltip:false},can_break={predicates:[{blocks:"#minecraft:bedblocks"}],show_in_tooltip:false},can_place_on={predicates:[{blocks:"#minecraft:bwplace"}],show_in_tooltip:false},enchantments={"sharpness":1}] 1
...
give @a[scores={bw.axe=1..1},gamemode=!spectator,tag=bw.play,nbt=!{Inventory:[{id:"minecraft:wooden_axe"}]}] wooden_axe[attribute_modifiers={modifiers:[{type:"attack_damage",slot:"any",id:"uuid_7777842599633879",amount:1d,operation:"add_value"}],show_in_tooltip:false},enchantments={levels:{"minecraft:efficiency":1s},show_in_tooltip:false},unbreakable={show_in_tooltip:false},custom_data={bw:1},can_place_on={predicates:[{blocks:"#minecraft:bwplace"}],show_in_tooltip:false},can_break={predicates:[{blocks:"#minecraft:bedblocks"}],show_in_tooltip:false}]
...
give @a[scores={bw.axe=2..2},gamemode=!spectator,tag=bw.play,nbt=!{Inventory:[{id:"minecraft:iron_axe"}]}] iron_axe[attribute_modifiers={modifiers:[{type:"attack_damage",slot:"any",id:"uuid_7777842599633879",amount:2d,operation:"add_value"}],show_in_tooltip:false},enchantments={levels:{"minecraft:efficiency":1s},show_in_tooltip:false},unbreakable={show_in_tooltip:false},custom_data={bw:1},can_place_on={predicates:[{blocks:"#minecraft:bwplace"}],show_in_tooltip:false},can_break={predicates:[{blocks:"#minecraft:bedblocks"}],show_in_tooltip:false}]
