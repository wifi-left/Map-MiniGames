...
execute if score bw.state state matches 1.. as @a[tag=bw.play] at @s as @e[distance=0..5,type=item,tag=!flaged] run data merge entity @s {Item:{components:{"minecraft:can_break":[{blocks:"#minecraft:bedblocks"}],"minecraft:tooltip_display":{hidden_components:["minecraft:can_break","minecraft:can_place_on"]},"minecraft:can_place_on":[{blocks:"#minecraft:bwplace"}]}}}
