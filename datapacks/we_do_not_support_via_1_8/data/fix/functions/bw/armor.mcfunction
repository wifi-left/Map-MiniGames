...
## 
give @a[tag=bwneeds,gamemode=!spectator,tag=bw.play] minecraft:wooden_sword[custom_data={bw:1},unbreakable={show_in_tooltip:false},can_break={predicates:[{blocks:["#minecraft:bedblocks"]}],show_in_tooltip:false},can_place_on={predicates:[{blocks:["#minecraft:bwplace"]}],show_in_tooltip:false}]
...
give @a[scores={bw.axe=2..2},gamemode=!spectator,tag=bw.play,nbt=!{Inventory:[{id:"minecraft:iron_axe"}]}] iron_axe[attribute_modifiers={modifiers:[{type:"generic.attack_damage",slot:"any",uuid:[7777,8425,9963,3879],name:"noName",amount:2d,operation:"add_value"}],show_in_tooltip:false},enchantments={levels:{"minecraft:efficiency":1s},show_in_tooltip:false},unbreakable={show_in_tooltip:false},custom_data={bw:1},can_place_on={predicates:[{blocks:["#minecraft:bwplace"]}],show_in_tooltip:false},can_break={predicates:[{blocks:["#minecraft:bedblocks"]}],show_in_tooltip:false}]
