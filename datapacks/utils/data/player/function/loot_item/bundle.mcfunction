...
execute if items entity @s weapon.offhand * run data modify entity @e[limit=1,type=item,tag=loot.new] Item.components."minecraft:bundle_contents" append from entity @s equipment.offhand
