...
give @a[scores={bw.axe=2..2},nbt=!{Inventory:[{id:"minecraft:iron_axe"}]}] iron_axe{AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"noName",Amount:5d,Operation:0,UUID:[I;7777,8425,9963,3879]}],Enchantments:[{id:"minecraft:efficiency",lvl:1s}],Unbreakable:1b,bw:1,HideFlags:63,CanPlaceOn:["#minecraft:bwplace"],CanDestroy:["#minecraft:bedblocks"]}
...
give @a[scores={bw.axe=3..3},nbt=!{Inventory:[{id:"minecraft:diamond_axe"}]}] diamond_axe{AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"noName",Amount:7d,Operation:0,UUID:[I;7777,8425,9963,3879]}],Enchantments:[{id:"minecraft:efficiency",lvl:1s}],Unbreakable:1b,bw:1,HideFlags:63,CanPlaceOn:["#minecraft:bwplace"],CanDestroy:["#minecraft:bedblocks"]}
