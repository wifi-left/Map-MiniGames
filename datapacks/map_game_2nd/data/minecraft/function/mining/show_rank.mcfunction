...
execute as @a[tag=mining.win] run tellraw @s ["\u00a7a第一名（你）：",{selector:"@a[tag=mining.win]",color:aqua},{text:" (",color:green,extra:["",{score:{name:"mining.max",objective:board},color:"light_purple"},"分)"]}]
...
tag @a[tag=mining.win] remove mining.tobecalc
execute as @a[tag=mining.win] run team leave @s
execute as @a[tag=mining.win] run tellraw @s ["\u00a7e第二名（你）：",{selector:"@a[tag=mining.win]",color:aqua},{text:" (",color:green,extra:["",{score:{name:"mining.max",objective:board},color:"light_purple"},"分)"]}]
...
tag @a[tag=mining.win] remove mining.tobecalc
execute as @a[tag=mining.win] run team leave @s
execute as @a[tag=mining.win] run tellraw @s ["\u00a7d第三名（你）：",{selector:"@a[tag=mining.win]",color:aqua},{text:" (",color:green,extra:["",{score:{name:"mining.max",objective:board},color:"light_purple"},"分)"]}]
