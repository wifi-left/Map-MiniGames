...
execute as @a[team=mining,gamemode=adventure] run scoreboard players add wait.player tick 1


execute if score mining.state state matches 1.. run return run function minecraft:mining/spec
...
execute if score wait.player tick matches 2.. in airworld positioned -96 49 610 run function minecraft:mining/start
