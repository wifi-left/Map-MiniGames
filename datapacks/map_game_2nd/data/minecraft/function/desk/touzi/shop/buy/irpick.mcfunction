...
## 
scoreboard players set touzi.shop.id board 3
scoreboard players set touzi.shop.need board 1500
...
$execute if score touzi.shop.success board matches 1 run tellraw @a[team=deskgame,tag=touzi.team.$(team)] [{"selector":"@s"},"\u00a7a购买了",{"text":"铁镐骰子","color":"aqua"},"\u00a7a，将其替换了",{"text":"骰子$(place)","color": "yellow","bold": true}]
