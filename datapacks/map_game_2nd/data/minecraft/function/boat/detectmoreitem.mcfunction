...
execute store result score boat.tmp board run clear @s carrot_on_a_stick[custom_data~{boatItem:3b}] 0
execute if score boat.tmp board matches 2.. run clear @s carrot_on_a_stick[custom_data~{boatItem:3b}]
