...
execute if score boat.type board matches 2 run summon minecraft:pig ~ ~ ~ {CustomNameVisible:1b,Invulnerable:1b,Silent:1b,PersistenceRequired:1b,Tags:["boat","boat.new"],DeathLootTable:"minecraft:empty",Team:"boat",NoAI:1b,attributes:[{base:0.22d,id:"movement_speed"}],equipment:{saddle:{id:"saddle"}}}
execute if score boat.type board matches 5 run summon minecraft:horse ~ ~ ~ {CustomNameVisible:1b,Invulnerable:1b,Silent:1b,PersistenceRequired:1b,Tags:["boat","boat.new"],DeathLootTable:"minecraft:empty",Team:"boat",NoAI:1b,Tame:true,equipment:{saddle:{id:"saddle"}},Temper:100,attributes:[{base:0.3d,id:"movement_speed"},{base:0.6d,id:"horse.jump_strength"}]}
