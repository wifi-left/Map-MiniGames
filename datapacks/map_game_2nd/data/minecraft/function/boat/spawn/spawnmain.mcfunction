...
execute if score boat.type board matches 2 run summon minecraft:pig ~ ~ ~ {CustomNameVisible:1b,Invulnerable:1b,Silent:1b,PersistenceRequired:1b,Tags:["boat","boat.new"],DeathLootTable:"minecraft:empty",Saddle:1b,Team:"boat",NoAI:1b,attributes:[{base:0.22d,id:"movement_speed"}]}
