...
execute as @a[team=ballgame,tag=ball.teama] run scoreboard players add ball.teama.player tick 1
execute as @a[team=ballgame,tag=ball.teamb] run scoreboard players add ball.teamb.player tick 1
