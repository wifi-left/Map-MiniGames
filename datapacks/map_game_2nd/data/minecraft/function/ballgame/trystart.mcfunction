...
execute as @a[team=ballgame,gamemode=adventure] run scoreboard players add wait.player tick 1


execute if score ballgame.state state matches 1.. run return run function minecraft:ballgame/spec
...
execute if score wait.player tick matches 2.. run function minecraft:ballgame/start
