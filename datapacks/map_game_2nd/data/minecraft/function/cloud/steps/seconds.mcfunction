...
execute if score sw.state state matches 2..99 if score cloud.countdown board matches 1.. if score cloud.step board matches 2..5 run title @a[tag=sw.msg] actionbar ["\u00a7a即将\u00a7d补充箱子\u00a7a：",{"score":{"name": "cloud.countdown","objective": "board"},"color": "gold"},"\u00a76s"]
execute if score sw.state state matches 2..99 if score cloud.countdown board matches 1.. if score cloud.step board matches 6.. run title @a[tag=sw.msg] actionbar ["\u00a7a即将\u00a7c结束游戏\u00a7a：",{"score":{"name": "cloud.countdown","objective": "board"},"color": "gold"},"\u00a76s"]
