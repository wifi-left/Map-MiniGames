...
execute as @a[team=btw.play.a,gamemode=adventure] if predicate [{"condition":"entity_properties","entity":"this","predicate":{"type_specific/player":{input:{jump:true}}}}] run function minecraft:boatwars/action/jump
execute as @a[team=btw.play.b,gamemode=adventure] if predicate [{"condition":"entity_properties","entity":"this","predicate":{"type_specific/player":{input:{jump:true}}}}] run function minecraft:boatwars/action/jump
