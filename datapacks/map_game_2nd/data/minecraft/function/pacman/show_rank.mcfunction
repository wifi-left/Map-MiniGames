...
execute as @a[tag=pacman.win] run tellraw @s ["\u00a7a第一名（你）：",{selector:"@s",color:aqua},{text:" (",color:green,extra:["",{score:{name:"pacman.max",objective:board},color:"light_purple"},"分)"]}]
...
tag @a[tag=pacman.win] remove pacman.tobecalc
execute as @a[tag=pacman.win] run team leave @s
execute as @a[tag=pacman.win] run tellraw @s ["\u00a7e第二名（你）：",{selector:"@s",color:aqua},{text:" (",color:green,extra:["",{score:{name:"pacman.max",objective:board},color:"light_purple"},"分)"]}]
...
tag @a[tag=pacman.win] remove pacman.tobecalc
execute as @a[tag=pacman.win] run team leave @s
execute as @a[tag=pacman.win] run tellraw @s ["\u00a7d第三名（你）：",{selector:"@s",color:aqua},{text:" (",color:green,extra:["",{score:{name:"pacman.max",objective:board},color:"light_purple"},"分)"]}]
