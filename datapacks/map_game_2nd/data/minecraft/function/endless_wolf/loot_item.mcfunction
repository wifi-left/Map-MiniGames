...
execute if score tmp board matches 1..2 run summon item ~ ~ ~ {Item:{id:"minecraft:stone_sword",count:1,components:{item_name:{text:"被圣水浸泡过的石剑"},custom_data:{vampire:shengwu}}},Glowing:true,CustomNameVisible:true}
execute if score tmp board matches 3 run summon item ~ ~ ~ {Item:{id:"minecraft:iron_sword",count:1,components:{max_damage:1,enchantments:{sharpness:2},attribute_modifiers:[{id:attack_speed,type:attack_speed,amount:3,operation:"add_value",slot:"mainhand"},{id:attack,type:attack_damage,amount:18,operation:"add_value",slot:"mainhand"}],custom_data:{vampire:shengwu},item_name:'充分吸收过阳光、浸泡过圣水、含有大蒜的银质十字架'}},Glowing:true,CustomNameVisible:true}
...
execute if score tmp board matches 31..32 run summon item ~ ~ ~ {Item:{id:"minecraft:shield",count:1,components:{item_name:{text:"被圣水浸泡过的盾牌"},custom_data:{vampire:shengwu}}},Glowing:true,CustomNameVisible:true}
