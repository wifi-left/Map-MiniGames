...
execute as @a[team=play.endwolf,tag=endless.vampire] at @s unless items entity @s container.* end_rod[custom_data~{vampire:true}] unless items entity @s armor.* end_rod[custom_data~{vampire:true}] run function minecraft:endless_wolf/vampire_item
