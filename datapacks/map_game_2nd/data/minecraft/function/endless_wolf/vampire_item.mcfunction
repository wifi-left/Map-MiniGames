...
execute if score endwolf.state state matches 2 run item replace entity @s hotbar.7 with end_rod[custom_name="\u00a7c吸血鬼象征 (可穿戴在头上)",lore=["\u00a77白天可以减轻烧伤程度。方便吸血鬼们互相识别","还能减少重力加速度，让你飞起来（不是）"],custom_data={vampire:true},equippable={slot:"head",swappable:true},attribute_modifiers=[{id:gravity,amount:-0.05,operation:"add_value",type:gravity,slot:head},{id:jump,amount:0.1,operation:"add_value",type:jump_strength,slot:head},{id:air,amount:10,operation:"add_value",type:safe_fall_distance,slot:head},{id:movement_speed,amount:0.1,operation:"add_value",type:movement_speed,slot:head},{id:air,amount:10,operation:"add_value",type:safe_fall_distance,slot:head}]]
execute if score endwolf.state state matches 1 run item replace entity @s hotbar.7 with end_rod[custom_name="\u00a7c吸血鬼象征 (可穿戴在头上)",lore=["\u00a77白天可以减轻烧伤程度。方便吸血鬼们互相识别","削弱版"],custom_data={vampire:true},equippable={slot:"head",swappable:true},attribute_modifiers=[]]
