...
item replace entity @s hotbar.8 with end_rod[custom_name='"\\u00a7c吸血鬼象征 (可穿戴在头上)"',lore=['"\\u00a77白天可以减轻烧伤成都。方便吸血鬼们互相识别"'],custom_data={vampire:true},enchantments={protection:1},equippable={slot:"head",swappable:true}]