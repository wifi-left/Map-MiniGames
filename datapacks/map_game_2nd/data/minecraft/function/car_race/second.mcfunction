...
execute as @a[team=car.play,gamemode=adventure] unless items entity @s container.* carrot_on_a_stick[custom_data~{gcar:2}] run item replace entity @s weapon.offhand with carrot_on_a_stick[custom_data={gcar:2},custom_name='"\\u00a7a"',hide_tooltip={},unbreakable={},custom_model_data={floats:[16f]}] 1
effect give @a[team=car.play] night_vision 1 1 true
effect give @a[team=car.wait] night_vision 1 1 true
