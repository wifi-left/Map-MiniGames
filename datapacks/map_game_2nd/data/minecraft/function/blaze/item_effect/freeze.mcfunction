...
execute as @s[team=blaze.team.a] at @s as @a[team=blaze.team.b,distance=..10] run damage @s 2 minecraft:freeze
...
execute as @s[team=blaze.team.b] at @s as @a[team=blaze.team.a,distance=..10] run damage @s 2 minecraft:freeze
