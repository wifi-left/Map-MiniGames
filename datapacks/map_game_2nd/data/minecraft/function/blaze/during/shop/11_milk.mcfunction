...
# 需要的金币
scoreboard players set blaze.need board 100
...
# 购买的物品
give @s paper[item_model='potion',potion_contents={custom_color:16777215},custom_name=[{italic:false,text:"瓶装牛奶",color:green},{text:" - 右键饮用",color:gray}],consumable={animation:"drink",consume_seconds:2,has_consume_particles:false,sound:"entity.generic.drink",on_consume_effects:[{type:"clear_all_effects"}]}] 1