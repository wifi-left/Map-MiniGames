...
# 需要的金币
scoreboard players set blaze.need board 200
...
# 购买的物品
give @s paper[item_model='snowball',item_name=[{text:"飞行雪球"},{text:" - 长按右键使用",color:gray}],consumable={animation:"bow",consume_seconds:3,has_consume_particles:false,sound:"ui.hud.bubble_pop"},custom_data={blaze:"fly"}] 1