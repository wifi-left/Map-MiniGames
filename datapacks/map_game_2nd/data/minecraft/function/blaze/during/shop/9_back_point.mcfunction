...
# 需要的金币
scoreboard players set blaze.need board 300
...
# 购买的物品
give @s paper[item_name=[{text:"回城卷轴"},{text:" - 长按右键使用 (3s)",color:gray}],consumable={animation:"bow",consume_seconds:3,has_consume_particles:false,sound:"ui.hud.bubble_pop"},custom_data={blaze:"back_base"}] 1