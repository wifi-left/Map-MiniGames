...
give @s ice[item_name={text:"冰"},custom_name={text:'冰',italic:false},lore=[{text:"攻击嘎嘎的低",italic:false,color:aqua}],custom_data={blaze:"job"},attribute_modifiers=[{id:"sword",amount:1,operation:"add_value",type:"attack_damage",display:{type:"override",value:{text:"3 攻击伤害",color:"dark_aqua"}}}]]
give @s blue_ice[item_name={text:"冻"},custom_name=[{text:'冻',color:aqua,italic:false},{text:" - 长按施展",color:gray}],lore=[{text:"【快点冻上吧！「冻结了！」快点冻上吧「冻僵了！」】",italic:false,color:dark_aqua}],custom_data={blaze:"job",blaze_skill:"freeze_skill"},consumable={animation:"bow",consume_seconds:5,has_consume_particles:false,sound:"block.amethyst_cluster.place"}]