...
# 购买的物品
item replace entity @s armor.head with leather_helmet[unbreakable={},custom_data={blaze:"job"}] 1
item replace entity @s armor.chest with chainmail_chestplate[enchantments={projectile_protection:1},unbreakable={},custom_data={blaze:"job"}] 1
item replace entity @s armor.legs with chainmail_leggings[unbreakable={},enchantments={projectile_protection:1},custom_data={blaze:"job"}] 1
item replace entity @s armor.feet with leather_boots[unbreakable={},custom_data={blaze:"job"}] 1
give @s wooden_sword[unbreakable={},custom_data={blaze:"job"}] 1
give @s bow[unbreakable={},enchantments={punch:1,power:1},custom_data={blaze:"job"}] 1
give @s arrow[unbreakable={},custom_data={blaze:"job"}] 32