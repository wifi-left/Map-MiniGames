...
give @s paper[item_model='bow',item_name=[{text:"飞行弓"},{text:" - 长按右键使用",color:gray}],consumable={animation:"bow",consume_seconds:3,has_consume_particles:false,sound:"block.note_block.didgeridoo"},custom_data={blaze_skill:"fly_bow",blaze:"job"},attribute_modifiers=[{id:"safe",amount:10,operation:"add_value",type:"safe_fall_distance",slot:"any",display:{type:"override",value:{text:"持有此可防止+10格摔伤",color:"light_purple"}}}],use_cooldown={seconds:5,cooldown_group:"fly_bow"}] 1
give @s paper[item_model='black_harness',item_name=[{text:"鸟目"},{text:" - 长按右键使用 (3s)",color:gray}],consumable={animation:"bow",consume_seconds:3,has_consume_particles:false,sound:"block.note_block.banjo"},custom_data={blaze_skill:"blind_skill",blaze:"job"},use_cooldown={seconds:10,cooldown_group:"blind"}] 1
give @s paper[item_model='tripwire_hook',item_name=[{text:"歌唱"},{text:" - 长按右键 (3s)",color:gray}],consumable={animation:"block",consume_seconds:3,has_consume_particles:false,sound:"entity.parrot.ambient"},custom_data={blaze_skill:"singing_skill",blaze:"job"},use_cooldown={seconds:10,cooldown_group:"singing"}] 1
