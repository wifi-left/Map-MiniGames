team modify blaze.team.a prefix [{text:"[燎]",color:gold},{text:"<警>",color:aqua},' ',{text:"队伍A",color:blue},' ',{text:"|",color:"dark_gray"},' ']
team modify blaze.team.b prefix [{text:"[燎]",color:gold},{text:"<匪>",color:dark_red},' ',{text:"队伍B",color:red},' ',{text:"|",color:"dark_gray"},' ']
