...
execute if score blaze.state state matches 2..10 if score blaze.mode state matches 2 if score blaze.team.b.alive tick matches ..0 run function minecraft:blaze/during/pvp/round_win/a
execute if score blaze.state state matches 2..10 if score blaze.mode state matches 2 if score blaze.team.a.alive tick matches ..0 run function minecraft:blaze/during/pvp/round_win/b

execute if score blaze.state state matches 2..10 if score blaze.mode state matches 3 if score blaze.team.b.alive tick matches ..0 run function minecraft:blaze/during/police/round_win/a
execute if score blaze.state state matches 2..10 if score blaze.mode state matches 3 if score blaze.team.a.alive tick matches ..0 run function minecraft:blaze/during/police/round_win/b