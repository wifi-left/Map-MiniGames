...
execute if score blaze.state state matches 2..10 if score blaze.mode state matches 2 run function minecraft:blaze/during/pvp_calc
execute if score blaze.state state matches 2..10 if score blaze.mode state matches 3 run function minecraft:blaze/during/check_or_next
execute if score blaze.state state matches 2..10 if score blaze.mode state matches 1 run function minecraft:blaze/during/check_or_next
