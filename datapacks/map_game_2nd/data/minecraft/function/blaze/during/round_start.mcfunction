...
execute if score blaze.mode state matches 3 if score blaze.police.state board matches 1 as @a[team=blaze.team.a] run function minecraft:blaze/during/tp/mid
execute if score blaze.mode state matches 3 if score blaze.police.state board matches 1 as @a[team=blaze.team.b] run function minecraft:blaze/during/tp/b
...
execute if score blaze.mode state matches 3 as @a[team=blaze.team.b] at @s run function minecraft:blaze/item/glass_pickaxe