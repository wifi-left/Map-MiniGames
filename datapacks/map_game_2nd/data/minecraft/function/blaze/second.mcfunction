...
execute if score blaze.state state matches 2..10 if score blaze.mode board matches 1 if score blaze.time board matches 1.. as @a[tag=blaze.player] run function minecraft:blaze/title_actionbar_normal

execute if score blaze.state state matches 2..10 if score blaze.mode board matches 1 if score blaze.time board matches 1.. if score blaze.special state matches 2 run function minecraft:blaze/during/time_reset_chest

execute if score blaze.state state matches 2..10 if score blaze.mode board matches 3 if score blaze.time board matches 1.. as @a[tag=blaze.player] run function minecraft:blaze/title_actionbar_normal
execute if score blaze.state state matches 2..10 if score blaze.mode board matches 2 if score blaze.time board matches 1.. as @a[tag=blaze.player] run function minecraft:blaze/title_actionbar_pvp
