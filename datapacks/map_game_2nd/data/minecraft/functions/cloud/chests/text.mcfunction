...
execute if score tmp.chest board matches 1 run data merge entity @s {text:'"\\u00a7a箱子 (剩余物品)"'}
execute if score tmp.chest board matches 0 run data merge entity @s {text:'"\\u00a77空箱子"'}
execute if score tmp.chest board matches 2 run data merge entity @s {text:'"\\u00a77箱子被破坏"'}