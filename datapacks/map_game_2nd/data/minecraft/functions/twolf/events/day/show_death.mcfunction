...
# 守卫 奶穿了
execute unless score wolf.setting.milked state matches 1.. as @a[tag=wolf.rescued,gamemode=adventure,team=wolfpeople] at @s run function twolf/action/per/death/died_no

# 守卫 防住了
execute as @a[tag=!wolf.rescued,gamemode=adventure,team=wolfpeople] at @s run function twolf/action/per/tag/protected

# 救援 成功了
execute as @a[tag=wolf.rescued,gamemode=adventure,team=wolfpeople] at @s run function twolf/action/per/tag/rescued

# 守卫守了寂寞
execute as @a[tag=wolf.protected,gamemode=adventure,team=wolfpeople] at @s run function twolf/action/per/tag/protected

# 女巫 毒药
execute as @a[tag=wolf.poisoned,gamemode=adventure,team=wolfpeople] at @s run function twolf/action/per/death/died_witch

# 纵火犯 火烧
execute as @a[tag=!wolf.killed,gamemode=adventure,team=wolfpeople] at @s run function twolf/action/per/death/died

# 纵火犯 火烧，把狼带走咯
execute as @a[tag=wolf.killed,gamemode=adventure,team=wolfpeople] at @s run function twolf/action/per/death/died_fired
