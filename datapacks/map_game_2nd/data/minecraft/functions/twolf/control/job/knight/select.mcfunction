...
execute if score @a[tag=wolf.selected,limit=1] LRS_JOB matches 7 as @a[tag=wolf.selected] run function twolf/action/per/death/knight_died 

execute unless score @a[tag=wolf.selected,limit=1] LRS_JOB matches 4 unless score @a[tag=wolf.selected,limit=1] LRS_JOB matches 7 as @a[tag=wolf.selected] run tellraw @a[tag=wolf.tip] ["\u00a7c\u00a7l骑士输了，对方是好人。"]
execute unless score @a[tag=wolf.selected,limit=1] LRS_JOB matches 4 unless score @a[tag=wolf.selected,limit=1] LRS_JOB matches 7 as @a[tag=wolf.selected] run function twolf/action/per/death/knight_died 
