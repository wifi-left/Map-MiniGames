...
execute if entity @a[tag=wolf.lastprotected] run tellraw @a[tag=wolf.acting] ["\u00a7d[!] \u00a7c你无法守护 ",{"selector":"@a[tag=wolf.selected]"},"\u00a7c，因为你昨晚守护了他。"]
execute if entity @a[tag=wolf.lastprotected] run return 0
