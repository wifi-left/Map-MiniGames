...
execute if score wolf.cupid.type board matches 1 as @a[tag=wolf.tip,gamemode=adventure,team=wolfpeople] if score @s LRS_JOB matches 5..6 run scoreboard players add wolf.r.god board 1
execute if score wolf.cupid.type board matches 1 as @a[tag=wolf.tip,gamemode=adventure,team=wolfpeople] if score @s LRS_JOB matches 8 run scoreboard players add wolf.r.god board 1
execute if score wolf.cupid.type board matches 1 as @a[tag=wolf.tip,gamemode=adventure,team=wolfpeople] if score @s LRS_JOB matches 9 run scoreboard players add wolf.r.person board 1
