...
execute if score wolf.cupid.type board matches 2 as @a[tag=wolf.connected,gamemode=adventure,team=wolfpeople] unless score @s LRS_JOB matches 1 run scoreboard players add wolf.r.cupids board 1
...
execute if score wolf.cupid.type board matches 2 as @a[tag=!wolf.connected,gamemode=adventure,team=wolfpeople] if score @s LRS_JOB matches 0 run scoreboard players add wolf.r.person board 1
execute if score wolf.cupid.type board matches 2 as @a[tag=!wolf.connected,gamemode=adventure,team=wolfpeople] if score @s LRS_JOB matches 2..3 run scoreboard players add wolf.r.god board 1
execute if score wolf.cupid.type board matches 2 as @a[tag=!wolf.connected,gamemode=adventure,team=wolfpeople] if score @s LRS_JOB matches 5..6 run scoreboard players add wolf.r.god board 1
execute if score wolf.cupid.type board matches 2 as @a[tag=!wolf.connected,gamemode=adventure,team=wolfpeople] if score @s LRS_JOB matches 8 run scoreboard players add wolf.r.god board 1
execute if score wolf.cupid.type board matches 2 as @a[tag=!wolf.connected,gamemode=adventure,team=wolfpeople] if score @s LRS_JOB matches 9 run scoreboard players add wolf.r.person board 1
...
## 炸弹人
execute as @a[tag=!wolf.connected,gamemode=adventure,team=wolfpeople] if score @s LRS_JOB matches 7 run scoreboard players add wolf.r.tnt board 1
