...
execute as @s[tag=skill.boat.trap] if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{trap:1}}}}] run tag @s add boat.trap.1
execute as @s[tag=skill.boat.trap] if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{trap:2}}}}] run tag @s add boat.trap.2
execute as @s[tag=skill.boat.trap] if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{trap:3}}}}] run tag @s add boat.trap.3
execute as @s[tag=skill.boat.trap] if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{trap:4}}}}] run tag @s add boat.trap.4
