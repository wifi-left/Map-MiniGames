...
execute if entity @e[tag=1] run give @s carrot_on_a_stick[unbreakable={},custom_name='"\\u00a7a\\u00a7l失明陷阱 \\u00a77- 右键使用"',custom_data={boatItem:4b,trap:1},custom_model_data=17]
execute if entity @e[tag=2] run give @s carrot_on_a_stick[unbreakable={},custom_name='"\\u00a7c\\u00a7l下车陷阱 \\u00a77- 右键使用"',custom_data={boatItem:4b,trap:2},custom_model_data=17]
