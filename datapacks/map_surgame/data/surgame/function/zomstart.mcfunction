...
item replace entity @s armor.head with minecraft:zombie_head[enchantments={"minecraft:binding_curse":1},attribute_modifiers=[{type:"armor",slot:head,id:"uuid_1041146773349500",amount:20d,operation:"add_value"},{type:"armor_toughness",slot:head,id:"uuid_2169772434783358",amount:4d,operation:"add_value"}]]
